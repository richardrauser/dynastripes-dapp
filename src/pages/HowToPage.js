            ...
            <Tabs defaultActiveKey={ selectedTab } id="uncontrolled-tab-example" className="mb-3">
              ...
              <h3>
                  ...
                  <ol>
                    ...
                    <li>Connect your wallet to the Polygon's Matic Mumbai network by tapping the "Ethereum Main Network" text (or whatever the current network is) at the top of the MetaMask window and select "Matic Mumbai". Mumbai is a test network where you will not be spending real funds.</li>
              ...
              Install Metamask & configure Mumbai network
                  ...
                  <ol>
                    ...
                    <li>Connect your wallet to Polygon's Matic Mumbai network. Tap the top left menu button in the MetaMask app and select "Wallet". Then tap the "Ethereum Main Network" (or whatever the current network is) text at the top and select "Matic Mumbai". Mumbai is a test network where you will not be spending real funds.</li>
                      <li>Use the <a className="externalLink" href="https://faucet.polygon.technology/" target="_blank" rel="noreferrer">Polygon Faucet</a> to send some test MATIC tokens your wallet. Simply copy your wallet's address from MetaMask and paste into the faucet website. </li> 
                  </ol>
