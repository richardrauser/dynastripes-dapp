          ...
          <div className="content">
            ...
            <div className="deepContent">
              ...
              <h3>
                ...
                <p>
                  The <span className="dyna">DynaStripes</span> project has been heavily influenced by existing on-chain, generative art projects like <a className="externalLink" href="https://www.larvalabs.com/autoglyphs" target="_blank">Autoglyphs</a>, <a className="externalLink" href="https://avastars.io/" target="_blank">Avastars</a>, <a className="externalLink" href="https://www.artblocks.io/" target="_blank">ArtBlocks</a>, <a className="externalLink" href="https://mandalas.eth.link/" target="_blank">Mandalas</a> and more. There are, however, two projects in particular that have served as the strongest inspiration for <span className="dyna">DynaStripes</span>:
                  <ol>
                  <li> 
                      <a className="externalLink" href="https://tinybox.shop/" target="_blank">TinyBoxes</a>: This "proto-generative," on-chain generative NFT project forged a new path by allowing users to select input parameters that influence the minted work.
                    </li>
                    <li> 
                    Simon de la Rouviere's <a className="externalLink" href="https://neolastics.com/" target="_blank">Neolastics</a> and also his extensive writings, particularly this <a className="externalLink" href='https://blog.simondlr.com/posts/flavours-of-on-chain-svg-nfts-on-ethereum' target="_blank">fascinating piece.</a>
                    </li>
                  </ol>
