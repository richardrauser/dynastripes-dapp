...
function networkConfigFor(currentNetwork) { 
    if (currentNetwork === DynaStripesLocalhostNetwork) {
        ...
        return {
            ...
            DynaStripesContractAddressKey: '0xE99d2fAF16F7ebAa32151f76946C3Be23B702b71' //pre-opensea support: '0xfE5b53733fA92D335e08dAe84fC98f98Fb8BD535'
        }
        ...
        return {
            ...
            DynaStripesContractAddressKey: '0x81D1DF5572d170ee9Dc471D021D6C630438D253A'
        }
    }
}
